...
def Cau2():
    ...
    def cv23():
        # mở file
        f = open("CA18A1A_BuiVanTai_44601_in.txt", mode="r", encoding="utf-8")
        ...
        f.close()
        print("==" * 10)
        print("Hoàn thành việc nhập dữ liệu từ file:CA18A1A_BuiVanTai_44601_out.txt ")
    ...
    def cv26():
        if len(data) == 0:
            ...
            # ghi dữ liệu
            f = open("CA18A1A_BuiVanTai_44601_out.txt", mode="w", encoding="utf-8")
            ...
            for i in data:
                if i.so_luong > 5:
                    ...
                    f.write(s)
            f.close()
        print("Hoàn thành ghi ra file:CA18A1A_BuiVanTai_44601_out.txt")
        print("==" * 20)
